            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li v-if="user.email==undefined">
                        <button type="button" class="btn btn-danger" @click="kakaoLogin">로그인</button>
                    </li>
                    <li v-else>
                        <button type="button" class="btn btn-danger" @click="kakaoLogout">로그아웃</button>
                    </li>
                </ul>
                <form class="d-flex">
    ...
    export default {
        ...
        methods: {
            ...
            async login(kakao_account) {
                await this.$api("https://1168783f-6ec2-4497-a0de-75c47cc93718.mock.pstmn.io/api/login", "post", {
                    param: [
